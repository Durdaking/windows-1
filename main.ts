...
forever(function () {
    if (Backdrop_selector == 3) {
        ...
        _2d_Game.setPosition(38, 70)
        _2d_Game.changeScale(0.1, ScaleAnchor.BottomLeft)
        The_Maze_Game_Test_Edition = sprites.create(assets.image`Test Game Selector`, SpriteKind.Test_Game_Selector)
        The_Maze_Game_Test_Edition.setPosition(38, 50)
        The_Maze_Game_Test_Edition.changeScale(0.1, ScaleAnchor.BottomLeft)
